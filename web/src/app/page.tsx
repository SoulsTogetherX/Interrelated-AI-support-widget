  ...
  return (
    <main className="landing">
      ...
      <p className="landing-tagline">
        An embeddable AI support widget that answers from your documentation
        with citations your visitors can check — every quoted span verified
        against the source before it is shown, and unverifiable claims
        stripped, not softened.
      </p>
